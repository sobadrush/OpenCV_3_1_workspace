...
public class Ch08_4_1_Canny_addWeight {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				try {
					Ch08_4_1_Canny_addWeight window = new Ch08_4_1_Canny_addWeight();
	...
	public Ch08_4_1_Canny_addWeight() {
		this.imgsrc = Imgcodecs.imread(FILEPATH_1, Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
		this.imgsrcRGB = Imgcodecs.imread(FILEPATH_1, Imgcodecs.CV_LOAD_IMAGE_COLOR);
		initialize();
	...
	private Mat mergeImage(Mat src1, Mat src2) {
		Mat dst = new Mat(src1.rows(), src1.cols(), src1.type());
		Core.addWeighted(src1, 0.5, src2, 0.5, 10, dst);
		return dst;
	}

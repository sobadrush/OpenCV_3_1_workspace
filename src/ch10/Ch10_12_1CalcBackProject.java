...
public class Ch10_12_1CalcBackProject {
	...
	private void initialize() {
		final Mat source = Imgcodecs.imread("E:\\workspace_OpenCV\\OpenCV_3.1\\images\\palm2.jpg");
		
		BufferedImage image=matToBufferedImage(source);
		
		frmjavaSwing = new JFrame();
		frmjavaSwing.setTitle("opencv �ϦV��v�m��");
		...
		slider_method.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				...
				BufferedImage newImage=matToBufferedImage(BackProject(slider_method.getValue()));
				lblNewLabel_2.setIcon(new ImageIcon(newImage));
			}
		});
	}
	public Mat BackProject(int bins){
		 Mat source2 = Imgcodecs.imread("E:\\workspace_OpenCV\\OpenCV_3.1\\images\\palm2.jpg");
		  Mat handle = new Mat();
	        ...
	        Imgproc.calcBackProject(Arrays.asList(handle), channels, hist, outputFrame, ranges, 1);
